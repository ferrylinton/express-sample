...
/**
 * Handler for Endpoint GET /api/todoes/:id
 * @param req {Object} The request.
...
/**
 * Handler for Endpoint PUT /api/todoes/:id
 * @param req {Object} The request.
 * @param req.params.id {String} Todo Id.
 * @param res {Object} The response.
 * @param {Function} next
...
const putTodoHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const updateResult = await todoService.update(req.params.id, { task, done });
...
/**
 * Handler for Endpoint DELETE /api/todoes/:id
 * @param req {Object} The request.
 * @param req.params.id {String} Todo Id.
 * @param res {Object} The response.
 * @param {Function} next
...
router.get("/api/todoes/:id", getTodoByIdHandler);
router.put("/api/todoes/:id", putTodoHandler);
